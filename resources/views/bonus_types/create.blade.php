    ...
    <div class="row justify-content-center">
        <div class="col-md-8 col-lg-7">
            ...
            <div class="form-section-panel">
                <h4 class="section-title">Add New Bonus Type ⭐</h4>

                <form action="{{ route('bonus_types.store') }}" method="POST">
                    @csrf
                    ...
                    <div class="row g-4">
                        ...
                        <div class="col-12">
                            ...
                            <input type="text" name="name" class="form-control-modern @error('name') is-invalid @enderror" id="name" placeholder="e.g., Annual Performance Bonus, Holiday Bonus" value="{{ old('name') }}" required>
                    ...
                    <div class="d-flex justify-content-end pt-4 mt-3">
                        <button type="submit" class="btn btn-primary btn-lg px-5 rounded-pill shadow">
                            <i class="bi bi-save me-2"></i> Save Bonus Type
                        </button>
                    </div>
                </form>
