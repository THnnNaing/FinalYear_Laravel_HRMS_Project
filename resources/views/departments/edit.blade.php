    ...
    <div class="row justify-content-center">
        ...
        <div class="col-md-8 col-lg-7">
            ...
            <div class="form-section-panel">
                {{-- Title reflects the action --}}
                <h4 class="section-title">Edit Department: {{ $department->name }} ✏️</h4>
                ...
                <form action="{{ route('departments.update', $department) }}" method="POST">
                    ...
                    <div class="row g-4">
                        ...
                        <div class="col-12">
                            ...
                            <input type="text" name="name" class="form-control-modern @error('name') is-invalid @enderror" id="name" value="{{ old('name', $department->name) }}" required>
                    ...
                    <div class="d-flex justify-content-end pt-4 mt-3">
                        <button type="submit" class="btn btn-primary btn-lg px-5 rounded-pill shadow">
                            <i class="bi bi-arrow-repeat me-2"></i> Update Department
                        </button>
                    </div>
                </form>
