    ...
    <div class="row justify-content-center">
        ...
        <div class="col-md-8 col-lg-7">
            ...
            <div class="form-section-panel">
                ...
                <h4 class="section-title">Edit Designation: {{ $designation->title }} ✏️</h4>
                ...
                <form action="{{ route('designations.update', $designation) }}" method="POST">
                    ...
                    <div class="row g-4">
                        ...
                        <div class="col-12">
                            ...
                            <input type="text" name="title" class="form-control-modern @error('title') is-invalid @enderror" id="title" placeholder="e.g., Senior Software Engineer" value="{{ old('title', $designation->title) }}" required>
                    ...
                    <div class="d-flex justify-content-end pt-4 mt-3">
                        <button type="submit" class="btn btn-primary btn-lg px-5 rounded-pill shadow">
                            <i class="bi bi-arrow-repeat me-2"></i> Update Designation
                        </button>
                    </div>
                </form>
