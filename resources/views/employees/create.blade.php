...
<div class="container container-custom">
    <div class="row justify-content-center">
        <div class="col-xl-10 col-lg-11">
            ...
            {{-- Back Button (Replaced Header and added custom class for hover) --}}
            <div class="d-flex justify-content-start align-items-center mb-5">
                ...
                @else
                <a href="{{ route('employees.index') }}" class="btn btn-outline-secondary-custom rounded-pill shadow-sm py-2 px-4">
                    <i class="bi bi-arrow-left me-2"></i> Back to Employee List
                </a>
                @endif
                @else
            ...
            {{-- Removed the main h1 "Add New Employee Record" here --}}
            ...
            <form action="{{ route('employees.store') }}" method="POST">
                ...
                <div class="row g-4">
                    ...
                    <div class="col-lg-6">
                        <div class="form-section-panel">
                            ...
                            {{-- Increased g-spacing to g-4 for more space between inputs --}}
                            <div class="row g-4">

                                {{-- First Name & Last Name (Side by Side) --}}
                                <div class="col-md-6">
                                    <label for="first_name" class="form-label">First Name <span class="text-danger">*</span></label>
                                    <input type="text" name="first_name" class="form-control-modern @error('first_name') is-invalid @enderror" id="first_name" value="{{ old('first_name') }}" required>
                                    @error('first_name') <div class="invalid-feedback">{{ $message }}</div> @enderror
                                </div>

                                <div class="col-md-6">
                                    <label for="last_name" class="form-label">Last Name <span class="text-danger">*</span></label>
                                    <input type="text" name="last_name" class="form-control-modern @error('last_name') is-invalid @enderror" id="last_name" value="{{ old('last_name') }}" required>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="date" name="dob" class="form-control-modern @error('dob') is-invalid @enderror" id="dob" value="{{ old('dob') }}" required>
                                    @error('dob') <div class="invalid-feedback">{{ $message }}</div> @enderror
                                </div>

                                <div class="col-md-6">
                                    <label for="phonenumber" class="form-label">Phone Number <span class="text-danger">*</span></label>
                                    <input type="tel" name="phonenumber" class="form-control-modern @error('phonenumber') is-invalid @enderror" id="phonenumber" value="{{ old('phonenumber') }}" required>
                                ...
                                <div class="col-12">
                                    ...
                                    <input type="text" name="nrc" class="form-control-modern @error('nrc') is-invalid @enderror" id="nrc" placeholder="e.g., 12/ABC123456" value="{{ old('nrc') }}" required>
                                ...
                                <div class="col-12">
                                    ...
                                    <input type="email" name="email" class="form-control-modern @error('email') is-invalid @enderror" id="email" value="{{ old('email') }}" required>
                    ...
                    <div class="col-lg-6">
                        ...
                        <div class="form-section-panel">
                            ...
                            <div class="row g-4">
                                <div class="col-12">
                                    ...
                                    {{-- Reduced rows to 2 for a "normal height" look, maintaining 100% width --}}
                                    <textarea name="address" class="form-control-modern @error('address') is-invalid @enderror" id="address" rows="2" required>{{ old('address') }}</textarea>
                        ...
                        <div class="form-section-panel">
                            ...
                            <div class="row g-4"> {{-- Increased g-spacing --}}

                                {{-- Basic Salary & Status (Side by Side) --}}
                                <div class="col-md-6">
                                    <label for="basic_salary" class="form-label">Basic Salary <span class="text-danger">*</span></label>
                                    <input type="number" name="basic_salary" class="form-control-modern @error('basic_salary') is-invalid @enderror" id="basic_salary" value="{{ old('basic_salary') }}" step="0.01" required>
                ...
                <div class="d-flex justify-content-end pt-4 mt-3">
                    <button type="submit" class="btn btn-primary btn-lg px-5 rounded-pill shadow">
                        <i class="bi bi-person-plus-fill me-2"></i> Save Employee Record
                    </button>
                </div>
            </form>
        </div>
