...
<div class="container container-custom mx-auto">
    ...
    <div class="text-center mb-5">
        <h1 class="display-5 fw-bold text-black mb-2">HR Dashboard</h1>
        <p class="text-black opacity-75">
            Welcome back, <strong>{{ Auth::user()->name }}</strong> — Manage your workforce
        </p>
    </div>
    ...
    <div class="row g-4 mt-4">
        <div class="col-md-4">
            <a href="{{ route('hr.employees.index') }}" class="text-decoration-none">
