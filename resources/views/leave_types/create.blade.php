    ...
    <div class="row justify-content-center">
        ...
        <div class="col-md-8 col-lg-7">
            ...
            <div class="form-section-panel">
                <h4 class="section-title">Add New Leave Type 🌴</h4>
                ...
                <form action="{{ route('leave_types.store') }}" method="POST">
                    ...
                    <div class="row g-4">
                        ...
                        <div class="col-12">
                            ...
                            <input type="text" name="name" class="form-control-modern @error('name') is-invalid @enderror" id="name" placeholder="e.g., Annual Leave, Sick Leave" value="{{ old('name') }}" required>
